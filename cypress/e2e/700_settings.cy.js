describe('load homepage', () => {
  ...
  it('modifies most settings, valid values, save', () => {
    ...
    cy.get('input#settings_movement_control_forward_speed').clear().type('100')
    cy.get('input#settings_movement_control_forward_elapse').clear().type('1')
    cy.get('input#settings_movement_control_turn_speed').clear().type('100')
    cy.get('input#settings_movement_control_turn_elapse').clear().type('1')
    cy.get('input#settings_movement_program_forward_speed').clear().type('100')
    cy.get('input#settings_movement_program_forward_elapse').clear().type('1')
    cy.get('input#settings_movement_program_turn_speed').clear().type('100')
    ...
    cy.get('#app').click()
    cy.get('button#1').click()
    cy.get('input#settings_movement_control_forward_speed').should('have.value', '100')
    cy.get('input#settings_movement_control_forward_elapse').should('have.value', '1')
    cy.get('input#settings_movement_control_turn_speed').should('have.value', '100')
    cy.get('input#settings_movement_control_turn_elapse').should('have.value', '1')
    cy.get('input#settings_movement_program_forward_speed').should('have.value', '100')
    cy.get('input#settings_movement_program_forward_elapse').should('have.value', '1')
    cy.get('input#settings_movement_program_turn_speed').should('have.value', '100')
