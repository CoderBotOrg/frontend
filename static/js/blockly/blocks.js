...
var CB_ENDPOINT = "localhost:5000"

get('http://'+CB_ENDPOINT+'/config', function(response) {
  /* Horrible workaround, FIXME

  I don't have the faintest idea about why we need to this
  CODERBOT_PROG_LEVEL is undefined here, and blocks.js needs 
  to be run or blocks configuratino missess things
  (it's duplicated in Blockly.vue component, somewhat both are needed ???)

  Be sure you have the CB_ENDPOINT correctly set here, too */
  settings = JSON.parse(response)
  var CODERBOT_PROG_LEVEL = settings.prog_level
  console.log("Getting configuration from '"+CB_ENDPOINT+"/config'"+
    "\n If this sounds wrong, correct CB_ENDPOINT in static/js/blockly/blocks.js")
